...
import com.mercadonarest.domain.exceptions.BarcodeFormatException;
...
public class ApiExceptionHandler {
    ...
    @ResponseBody
    public ErrorMessage constraintError(Exception exception) {
        return new ErrorMessage(exception,"Error restrición BD", HttpStatus.CONFLICT.value());
    }
